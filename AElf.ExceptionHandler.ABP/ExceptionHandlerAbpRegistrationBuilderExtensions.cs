...
public static class ExceptionHandlerAbpRegistrationBuilderExtensions
{
    public static IRegistrationBuilder<TLimit, TActivatorData, TRegistrationStyle> ConfigureExceptionHandlerAbpConventions<TLimit, TActivatorData, TRegistrationStyle>(
